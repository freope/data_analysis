...
from frestu.agent.trader.strategy.construction.period import StrategyRegularIntervalOpenAndSlope
from frestu.agent.trader.strategy.period import StrategyRegularInterval


class StrategyRegularIntervalOpenAndSlopeSimultaneous(StrategyParent):
    ...
    def __init__(
        ...
        strategy_0 = StrategyRegularIntervalOpenAndSlope(
            period_half, offset_open, offset_close, ma_type, window,
