...
from frestu.agent.trader.strategy.period import StrategyRegularIntervalAndReverseSlope


class StrategyRegularIntervalOpenAndReverseSlope(StrategyConstructorAbstract):
    
    def __init__(
            self,
            period_half, offset_open, offset_close, ma_type, window,
            window_slope=1, threshold_long=0, threshold_short=0):
        strategy_open = StrategyRegularIntervalAndReverseSlope(
