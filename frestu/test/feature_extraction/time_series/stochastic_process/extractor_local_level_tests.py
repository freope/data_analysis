...
class ExtractorLocalLevelTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.extractor = ExtractorLocalLevel(
            'val', 0, 10000000, 1000, 10000, True)
    ...
    def test_extract(self):
        ...
        self.assertLess(
            feature.loc['2020-01-01 17:10:00', 'sigma_filter'], 61.0)
        # mu_smooth
        self.assertGreater(
