...
class ExtractorRsiTests(unittest.TestCase):

    def setUp(self):
        self.extractor = ExtractorRsi(3)
    ...
    def test_extract(self):
        ...
        self.assertTrue(np.isnan(feature.loc['2020-01-01 17:02:00'][0]))
        self.assertEqual(feature.loc['2020-01-01 17:03:00'][0], 1)
        self.assertEqual(feature.loc['2020-01-01 17:10:00'][0], 1)
