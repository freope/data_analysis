...
class ExtractorMakingPastsNanTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.extractor = ExtractorMakingPastsNan(extractor, 5)
    ...
    def test_extract(self):
        ...
        self.assertTrue(np.isnan(feature.loc['2020-01-01 17:04:00'][0]))
        self.assertEqual(feature.loc['2020-01-01 17:05:00'][0], 15)
        self.assertEqual(feature.loc['2020-01-01 17:10:00'][0], 70)
