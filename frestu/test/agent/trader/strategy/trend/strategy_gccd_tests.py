...
from frestu.agent.trader.strategy.trend import StrategyGccd


class StrategyGccdTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyGccd(2, 3)
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertGreater(indicator.loc['2020-01-01 17:02:00'], 2.4)
        self.assertLess(indicator.loc['2020-01-01 17:02:00'], 2.6)
        self.assertGreater(indicator.loc['2020-01-01 17:10:00'], 9.8)
        self.assertLess(indicator.loc['2020-01-01 17:10:00'], 9.9)
