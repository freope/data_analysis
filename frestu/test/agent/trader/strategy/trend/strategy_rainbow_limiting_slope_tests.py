...
from frestu.agent.trader.strategy.trend import StrategyRainbowLimitingSlope


class StrategyRainbowLimitingSlopeTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyRainbowLimitingSlope(
            'ema', 10, 20, 35, threshold_slope_long=-1.0e-3)
