...
class StrategyGcdcTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyGcdc(2, 3)
    ...
    def test_create_positions(self):
        ...
        self.assertEqual(closed_position['opening_time'], '2020-01-01 17:02:00')
    ...
    def test_calculate_open_indicators(self):
        ...
        is_after_golden = indicator > 0
        self.assertTrue(is_after_golden.loc['2020-01-01 17:02:00'])
        self.assertFalse(is_after_golden.loc['2020-01-01 17:05:00'])
        self.assertFalse(is_after_golden.loc['2020-01-01 17:07:00'])
        self.assertTrue(is_after_golden.loc['2020-01-01 17:10:00'])
