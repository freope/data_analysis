...
from frestu.agent.trader.strategy.trend import StrategyHeikinashiCrossRawHa


class StrategyHeikinashiCrossRawHaTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = StrategyHeikinashiCrossRawHa(4, 'val', 'ha_open')
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertGreater(indicator.loc['2020-01-01 17:04:00'], 9.9)
        self.assertLess(indicator.loc['2020-01-01 17:04:00'], 10.1)
        self.assertGreater(indicator.loc['2020-01-01 17:10:00'], 44.4)
        self.assertLess(indicator.loc['2020-01-01 17:10:00'], 44.5)
