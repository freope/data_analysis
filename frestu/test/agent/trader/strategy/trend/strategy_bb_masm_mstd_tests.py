...
class StrategyBbMasmMstdTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyBbMasmMstd(0.1, 'sma', 2, 2)
    ...
    def test_calculate_open_indicators(self):
        ma_diff, sigma = self.strategy.calculate_open_indicators(self.df)
        # ma_diff
    ...
    def test_convert_indicators(self):
        ...
        can_open_short = self.strategy.convert_open_indicators(
            indicators, 'short')
        # long
        self.assertFalse(can_open_long['2020-01-01 17:02:00'])
        self.assertTrue(can_open_long['2020-01-01 17:03:00'])
        # short
