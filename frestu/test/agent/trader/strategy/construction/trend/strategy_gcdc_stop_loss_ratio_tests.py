...
from frestu.agent.trader.strategy.construction.trend import StrategyGcdcStopLossRatio


class StrategyGcdcStopLossRatioTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyGcdcStopLossRatio(2, 3, 0.01)
