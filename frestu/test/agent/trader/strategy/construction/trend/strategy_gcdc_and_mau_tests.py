...
from frestu.agent.trader.strategy.construction.trend import StrategyGcdcAndMau


class StrategyGcdcAndMauTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyGcdcAndMau(2, 3, [2, 3])
    ...
    def test_calculate_opening_times(self):
        ...
        otl = otsl[0]
        self.assertEqual(otl, '2020-01-01 17:03:00')
        otl = otsl[1]
    ...
    def test_create_positions(self):
        ...
        # closed
        self.assertEqual(len(closed_position), 2)
        closed_time = closed_position[0]
        self.assertEqual(closed_time['position_type'], 'long')
        self.assertEqual(closed_time['opening_time'], '2020-01-01 17:03:00')
