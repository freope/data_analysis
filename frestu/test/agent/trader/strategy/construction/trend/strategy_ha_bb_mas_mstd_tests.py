...
from frestu.agent.trader.strategy.construction.trend import StrategyHaBbMasMstd


class StrategyHaBbMasMstdTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyHaBbMasMstd(4, 0.01, 'sma', 3)
