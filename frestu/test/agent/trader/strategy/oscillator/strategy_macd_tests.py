...
from frestu.agent.trader.strategy.oscillator import StrategyMacd


class StrategyMacdTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyMacd(2, 3)
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertGreater(indicator.loc['2020-01-01 17:04:00'], 1.9)
        self.assertLess(indicator.loc['2020-01-01 17:04:00'], 2.0)
        self.assertGreater(indicator.loc['2020-01-01 17:10:00'], 7.4)
        self.assertLess(indicator.loc['2020-01-01 17:10:00'], 7.5)
