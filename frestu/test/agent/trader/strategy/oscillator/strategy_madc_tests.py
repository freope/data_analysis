...
from frestu.agent.trader.strategy.oscillator import StrategyMadc


class StrategyMadcTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyMadc(2, 3)
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertGreater(indicator.loc['2020-01-01 17:02:00'], 5.5)
        self.assertLess(indicator.loc['2020-01-01 17:02:00'], 5.6)
        self.assertGreater(indicator.loc['2020-01-01 17:10:00'], 9.2)
        self.assertLess(indicator.loc['2020-01-01 17:10:00'], 9.3)
