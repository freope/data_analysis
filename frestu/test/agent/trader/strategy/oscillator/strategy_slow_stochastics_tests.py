...
from frestu.agent.trader.strategy.oscillator import StrategySlowStochastics


class StrategySlowStochasticsTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategySlowStochastics(4, 3, 3)
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertGreater(indicator.loc['2020-01-01 17:07:00'], -0.26)
        self.assertLess(indicator.loc['2020-01-01 17:07:00'], -0.25)
        self.assertGreater(indicator.loc['2020-01-01 17:10:00'], 0.24)
        self.assertLess(indicator.loc['2020-01-01 17:10:00'], 0.25)
