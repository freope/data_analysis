...
from frestu.agent.trader.strategy.oscillator import StrategyFastStochastics


class StrategyFastStochasticsTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyFastStochastics(4, 3, 3)
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertGreater(indicator.loc['2020-01-01 17:05:00'], -0.70)
        self.assertLess(indicator.loc['2020-01-01 17:05:00'], -0.69)
        self.assertEqual(indicator.loc['2020-01-01 17:10:00'], 0.0)
