...
from frestu.agent.trader.strategy.oscillator import StrategyCci


class StrategyCciTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyCci(2, 3, 4)
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertTrue(np.isnan(indicator.loc['2020-01-01 17:07:00']))
        self.assertGreater(indicator.loc['2020-01-01 17:08:00'], 72)
        self.assertLess(indicator.loc['2020-01-01 17:08:00'], 73)
        self.assertGreater(indicator.loc['2020-01-01 17:10:00'], -32)
        self.assertLess(indicator.loc['2020-01-01 17:10:00'], -31)
