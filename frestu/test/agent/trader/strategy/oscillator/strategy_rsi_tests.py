...
from frestu.agent.trader.strategy.oscillator import StrategyRsi


class StrategyRsiTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyRsi(2, 0.5, 0.5)
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertTrue(np.isnan(indicator.loc['2020-01-01 17:01:00']))
        self.assertEqual(indicator.loc['2020-01-01 17:02:00'], 1.0)
        self.assertEqual(indicator.loc['2020-01-01 17:09:00'], 1.0)
    ...
    def test_convert_open_indicators(self):
        ...
        self.assertFalse(can_open_short['2020-01-01 17:10:00'])
