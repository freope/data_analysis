...
from frestu.agent.trader.strategy.oscillator import StrategyOsci


class StrategyOsciTests(unittest.TestCase):

    def setUp(self):
        self.strategy = StrategyOsci(2, 2, 3)
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertGreater(indicator.loc['2020-01-01 17:01:00'], 0.55)
        self.assertLess(indicator.loc['2020-01-01 17:01:00'], 0.56)
        self.assertGreater(indicator.loc['2020-01-01 17:09:00'], 2.0)
        self.assertLess(indicator.loc['2020-01-01 17:09:00'], 2.1)
