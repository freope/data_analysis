...
from frestu.agent.trader.strategy.part import StrategyPartTakeProfitRatio


class StrategyPartTakeProfitRatioTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy_take_profit = StrategyPartTakeProfitRatio(0.15)
