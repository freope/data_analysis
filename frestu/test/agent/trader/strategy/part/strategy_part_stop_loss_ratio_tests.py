...
class StrategyPartStopLossRatioTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy_stop_loss = StrategyPartStopLossRatio(0.15)
    ...
    def test_calculate_closing_times(self):
        ...
        closing_times = self.strategy_stop_loss.calculate_closing_times(
