...
class StrategyRegularIntervalAndCurvatureTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = StrategyRegularIntervalAndCurvature(3, 1, 'sma', 2)

    def tearDown(self):
        pass

    def test_calculate_open_indicators(self):
        curvature_ma, indicator_ri = self.strategy.calculate_open_indicators(
            self.df)

        # curvature_ma
        self.assertTrue(np.isnan(curvature_ma.loc['2020-01-01 17:00:00'][0]))
        self.assertTrue(np.isnan(curvature_ma.loc['2020-01-01 17:03:00'][0]))
        self.assertEqual(curvature_ma.loc['2020-01-01 17:04:00'][0], -7.5)
        self.assertEqual(curvature_ma.loc['2020-01-01 17:10:00'][0],-5)
    ...
    def test_convert_open_indicators(self):
        ...
        can_open_short = self.strategy.convert_open_indicators(
            indicators, 'short')
        # long
        self.assertFalse(can_open_long.loc['2020-01-01 17:06:00'])
        self.assertTrue(can_open_long.loc['2020-01-01 17:07:00'])
        # short
        self.assertFalse(can_open_short.loc['2020-01-01 17:03:00'])
        self.assertTrue(can_open_short.loc['2020-01-01 17:04:00'])
        self.assertFalse(can_open_short.loc['2020-01-01 17:09:00'])
        self.assertTrue(can_open_short.loc['2020-01-01 17:10:00'])
