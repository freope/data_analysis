...
class StrategyCombinatorWithAndTests(unittest.TestCase):

    def setUp(self):
        strategy1 = StrategyGcdc(window_shorter=2, window_longer=3)
        strategy2 = StrategyMau(windows=[2, 3, 4])
        strategies = [strategy1, strategy2]
        self.strategy = StrategyCombinatorWithAnd(strategies)
    ...
    def test_calculate_opeing_times(self):
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertFalse(open_indicators['long']['2020-01-01 17:03:00'])
        self.assertTrue(open_indicators['long']['2020-01-01 17:04:00'])
        self.assertFalse(open_indicators['long']['2020-01-01 17:07:00'])
        self.assertTrue(open_indicators['long']['2020-01-01 17:08:00'])
        self.assertFalse(open_indicators['short']['2020-01-01 17:05:00'])
        self.assertTrue(open_indicators['short']['2020-01-01 17:06:00'])
