...
from frestu.agent.trader.strategy.stochastic_process import StrategyLocalLevelCrossRawFilter


class StrategyLocalLevelCrossRawFilterTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = StrategyLocalLevelCrossRawFilter(
            'val', 0, 10000000, 1000, 10000)
