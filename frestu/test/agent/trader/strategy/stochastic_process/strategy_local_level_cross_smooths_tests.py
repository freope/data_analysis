...
from frestu.agent.trader.strategy.stochastic_process import StrategyLocalLevelCrossSmooths


class StrategyLocalLevelCrossSmoothsTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = StrategyLocalLevelCrossSmooths(
            'val', 1, 2, 0, 10000000, 1000, 10000)
    ...
    def test_create_positions(self):
        ...
        self.assertEqual(closed_position['closing_time'], '2020-01-01 17:06:00')
        self.assertEqual(closed_position['opening_rate'], 10)
        self.assertEqual(closed_position['closing_rate'], 5)
        closed_position = closed_positions[1]
        self.assertEqual(closed_position['position_type'], 'short')
        self.assertEqual(closed_position['opening_time'], '2020-01-01 17:06:00')
        self.assertEqual(closed_position['closing_time'], '2020-01-01 17:08:00')
        self.assertEqual(closed_position['opening_rate'], 5)
