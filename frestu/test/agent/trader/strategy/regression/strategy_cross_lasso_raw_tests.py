...
from frestu.agent.trader.strategy.regression import StrategyCrossLassoRaw
from frestu.data_type.data_frame import DataFrame


class StrategyCrossLassoRawTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = StrategyCrossLassoRaw.create(
