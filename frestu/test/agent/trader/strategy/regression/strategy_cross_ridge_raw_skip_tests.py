...
from frestu.agent.trader.strategy.regression import StrategyCrossRidgeRawSkip
from frestu.data_type.data_frame import DataFrame


class StrategyCrossRidgeRawSkipTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = StrategyCrossRidgeRawSkip.create(
    ...
    def test_calculate_open_indicators(self):
        ...
        self.assertGreater(indicator.loc['2020-01-01 17:08:00'], -63.3)
        self.assertLess(indicator.loc['2020-01-01 17:08:00'], -63.2)
