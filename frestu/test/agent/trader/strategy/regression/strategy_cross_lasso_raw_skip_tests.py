...
from frestu.agent.trader.strategy.regression import StrategyCrossLassoRawSkip
from frestu.data_type.data_frame import DataFrame


class StrategyCrossLassoRawSkipTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = StrategyCrossLassoRawSkip.create(
