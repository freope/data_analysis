...
from frestu.agent.trader.strategy.regression import StrategyCrossRidgeRawGev
from frestu.data_type.data_frame import DataFrame


class StrategyCrossRidgeRawGevTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.strategy = StrategyCrossRidgeRawGev.create(
            past_max=3, step_past=1,
