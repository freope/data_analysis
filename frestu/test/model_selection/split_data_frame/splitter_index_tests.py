...
from frestu.model_selection.split_data_frame import SplitterIndex


class SplitterIndexTests(unittest.TestCase):
    ...
    def test_split(self):
        ix_train = self.df.iloc[0:2, :].index
        ix_test = self.df.iloc[2:4,: ].index
        splitter = SplitterIndex(ix_train, ix_test, 'val_1')
